...
function encrypt($buffer){
	...
	$nBits = 128; //128,192,256
	
	$ciphertext = AesCtr::encrypt($buffer, $key, $nBits);

	return "<script type=\"text/javascript\" src='assets/js/functions.js'></script><script type=\"text/javascript\">
var he12p = 
('$key'); 
var gea = 
'$ciphertext';
var output = Aes.Ctr.decrypt(gea, he12p, $nBits);
